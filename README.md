...
# Jayachandra Pasupula  
**`Software Engineer`** 

## About Me
Experienced Software Engineer with over 4 years of expertise in Java and Python for developing scalable backend systems and full-stack applications. Proficient in leveraging Java frameworks like Spring Boot and Hibernate, and Python frameworks like Flask and Django. Skilled in designing and optimizing robust APIs, implementing microservices architecture, and enhancing application performance. Experienced with full-stack technologies including JavaScript, React, and Node.js. Adept at working with databases like MySQL, MongoDB, and DynamoDB. Committed to delivering high-quality, efficient, and scalable software solutions through effective software engineering practices, including SDLC, code reviews, and automation. Strong knowledge of data structures and high availability systems.


## Skill Stack
<!-- Skill icons provided by skill-icons. Full icon list and names:
     https://github.com/tandpfun/skill-icons?tab=readme-ov-file#icons-list -->
[![My Skills](https://skillicons.dev/icons?i=Java,aws,docker,git,github,terraform,python,typescript,nodejs,figma&theme=light)](https://skillicons.dev)
...
<!-- Section layout inspired by Awesome GitHub Profile README "Descriptive" patterns:
     https://github.com/abhisheknaiidu/awesome-github-profile-readme?tab=readme-ov-file#descriptive- -->
- [**Portfolio**](https://www.linkedin.com/in/jpasupula)
- [**Contact**](mailto:jpasupula97@gmail.com)

<a href="https://www.linkedin.com/in/jpasupula/" target="blank">
